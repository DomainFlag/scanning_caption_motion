...
void debugCorrespondenceMatching() {
    ...
    resultingMesh.writeMesh(std::string("../results/correspondences.off"));
}
...
int alignBunnyWithICP() {
    ...
    resultingMesh.writeMesh(std::string("../results/bunny_icp.off"));
...
int reconstructRoom() {
    ...
    std::string filenameBaseOut = std::string("../results/mesh_");
